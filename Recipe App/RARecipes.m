...
+ (NSArray *)recipes {
    ...
    return @[
             ...
             @{
                 ...
                 DirectionsKey : @[@"Butter a 20cm round cake tin (7.5cm deep) and line the base. Preheat the oven to fan 140C/conventional 160C/ gas 3. Break 200g good quality dark chocolate in pieces into a medium, heavy-based pan. Cut 200g butter into pieces and tip in with the chocolate, then mix 1 tbsp instant coffee granules into 125ml cold water and pour into the pan. Warm through over a low heat just until everything is melted â€“ donâ€™t overheat. Or melt in the microwave on Medium for about 5 minutes, stirring half way through.",
                                   @"While the chocolate is melting, mix 85g self-raising flour, 85g plain flour, Â¼ bicarbonate of soda, 200g light muscovado sugar, 200g golden caster sugar and 25g cocoa powder in a big bowl, mixing with your hands to get rid of any lumps. Beat 3 medium eggs in a bowl and stir in 75ml (5 tbsp) buttermilk.",
                                   @"Now pour the melted chocolate mixture and the egg mixture into the flour mixture, stirring just until everything is well blended and you have a smooth, quite runny consistency. Pour this into the tin and bake for 1 hour 25- 1 hour 30 minutes â€“ if you push a skewer in the centre it should come out clean and the top should feel firm (donâ€™t worry if it cracks a bit). Leave to cool in the tin (donâ€™t worry if it dips slightly), then turn out onto a wire rack to cool completely.",
